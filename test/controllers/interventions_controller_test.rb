...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { detail: @intervention.detail, name: @intervention.name } }
    end
  ...
  test "should update intervention" do
    patch intervention_url(@intervention), params: { intervention: { detail: @intervention.detail, name: @intervention.name } }
